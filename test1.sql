...
INSERT ALL
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Alicia','García','Campos','47812333','929 185 236','agarcia@gmail.com','Av. Paula Sotelo # 423 Dpto. 073','140409')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Juana','�?vila','Chumpitaz','15487922','923 568 741','javila@gmail.com','Jr. Ignacio Alicea # 7304','140402')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Oscar','Coronado','Vásquez','15253588','932 615 478','ocoronado@gmail.com','Cl. Axel Aranda # 2 Hab. 133','140403')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Luis','Barrios','Palomino','85213566','932 817 645','lbarrios@outlook.com','Cl. Juan José Meléndez # 5','140409')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('María','Tarazona','Mendoza','15482566','978 400 123','mtarazona@outlook.com','Urb. Isaac Olmos # 4648','140407')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Pedro','Sánchez','Dávila','15428211','941 533 268','psanchez@yahoo.com','Av. Juan Diego Rivero # 12','140402')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Aldo','Torres','Zavala','47129533','958 866 221','atorres@yahoo.com','Urb. Juan José Portillo # 3 Piso 2','140405')
       ...
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Gloria','Linares','Rodríguez','15429866','954 415 950','glinares@hotmail.com','Cl. Montserrat Sánchez # 8955 Piso 2','140403')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Esperanza','Stark','Parker','85251592','901 133 258','estark@yahoo.com','Urb. Juan José Portillo # 3 Piso 2','140405')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Esmeralda','Sánchez','Lévano','15437783','918 253 554','Esmesan@gmail.com','Cl. Juan José Meléndez # 5','140409')
       ...
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Carmen','Sánchez','Sánchez','15385177','926 327 843','Carmen@gmail.com','Cl. Juan José Meléndez # 5','140409')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Miguel','Sánchez','De la cruz','87214363','907 547 644','Miguelcruz@outlook.com','Cl. Josefina Guillen # 466 Piso 48','140408')
       ...
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Ruben','Ruiz','Quispe','15745889','918 746 334','rubenquispe@yahoo.com','Urb. Juan José Portillo # 1 Piso 1','140405')
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Alvaro','Alcala','Quispe','15545889','918 746 367','Alvaroalcala@outlook.es','Urb. Juan José Portillo # 3 Piso 2','140405')
       ...
       INTO CLIENTE (nombres, apellido_paterno, apellido_materno, dni, celular, email, domicilio, ubigeo_codigo) VALUES ('Cristhian','Contreras','Barrios','15438799','915 112 334','cristhianbarrios@yahoo.com','Urb. Juan José Portillo # 1 Piso 4','140405')
       SELECT * FROM DUAL
COMMIT;
...
INSERT ALL
       ...
       INTO PRODUCTO (nombre, descripcion, precio, categoria, stock) VALUES('Sopa seca de Camarón','La tipica comida sopa seca de Lunahuana con el rico camaron',40.00,'S','10')
       INTO PRODUCTO (nombre, descripcion, precio, categoria, stock) VALUES('Picante de Camarón','El rico camaron con el toque picante que nos gusta',40.00,'S','10')
       ...
       INTO PRODUCTO (nombre, descripcion, precio, categoria, stock) VALUES('Ceviche de Camarón','El rico camaron sin cascara con el toque de ceviche',40.00,'S','10')
       INTO PRODUCTO (nombre, descripcion, precio, categoria, stock) VALUES('Porcion de yuca','Porcion de 12 yuquitas fritas',10.00,'E','10')
       INTO PRODUCTO (nombre, descripcion, precio, categoria, stock) VALUES('Chupe de Camarón','Un rico caldo de camarones',40.00,'S','10')
       ...
       INTO PRODUCTO (nombre, descripcion, precio, categoria, stock) VALUES('Porcion de tequeños','Tequeños con cremas',10.00,'E','10')
